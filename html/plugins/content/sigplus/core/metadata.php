...
class SigPlusNovoMetadataServices {
	...
	*/
	...
	private static function convertCharacterEncoding($charset_in, $charset_out, $str) {
		...
		if (extension_loaded('mbstring') && !mb_check_encoding($str, $charset_in)) {
			return false;
		}
	...
	*/
	public static function getImageMetadata($imagefile) {
		...
		if (true) {  // whether to include EXIF information in metadata, change "false" to "true" to extract EXIF data
