...
<script type="text/javascript">
    Joomla.submitbutton = function(task)
    {
        ...
        if(task == 'general.apply1' || task == 'general.save') {
...
<div id="j-sidebar-container" class="j-sidebar-container j-sidebar-visible" style="margin-top:1px;border-top: 1px solid #e3e3e3;">
...
<?php $path_site2 = JUri::root()."media/com_portfoliogallery/images" ?>
	...
	<div class="free_version_banner">
		...
		<p class="usermanual_text">If you have any difficulties in using the options, Follow the link to <a href="http://huge-it.com/joomla-portfolio-gallery-user-manual-2/" target="_blank">User Manual</a></p>
...
<form action="<?php echo JRoute::_('index.php?option=com_portfoliogallery'); ?>" id="application-form" method="post" name="adminForm" class="form-validate">
    <div class="row-fluid">
        <div class="span10" style = 'width:100%'>
            <ul class="nav nav-tabs">
                ...
                <li><a href="#page-system" data-toggle="tab"><?php echo JText::_('COM_CONFIG_FULLHEIGHTBLOCK'); ?></a></li>
                <li><a href="#page-server" data-toggle="tab"><?php echo JText::_('COM_CONFIG_GALLERYCONTENT'); ?></a></li>
                <li><a href="#page-perm" data-toggle="tab"><?php echo JText::_('COM_CONFIG_FULLWIDTH'); ?></a></li>
                <li><a href="#page-filters" data-toggle="tab"><?php echo JText::_('COM_CONFIG_TEXT_FAQTOGGLE'); ?></a></li>
                <li><a href="#page-filters_" data-toggle="tab"><?php echo JText::_('COM_CONFIG_TEXT_CONTENTSLIDER'); ?></a></li>
                <li><a href="#page-lightboxgallery" data-toggle="tab"><?php echo JText::_('COM_CONFIG_TEXT_LIGHTBOXGALLERY'); ?></a></li>
            ...
            <div id="config-document" class="tab-content" class="dconfig" >
                <div id="page-site" class="tab-pane active">
                    <div class="row-fluid">
                        <?php echo $this->loadTemplate('blockstoggle'); ?>
                    </div>
                </div>
                <div id="page-system" class="tab-pane">
                    <div class="row-fluid">
                        <?php echo $this->loadTemplate('fullheight'); ?>    
                    </div>
                </div>
                <div id="page-server" class="tab-pane">
                    <div class="row-fluid">
                        <?php echo $this->loadTemplate('contentpopup'); ?>    
                    </div>
                </div>
                <div id="page-perm" class="tab-pane">
                    <div class="row-fluid">
                        <?php echo $this->loadTemplate('fullwidthblocks'); ?>      
                    </div>
                </div>
                <div id="page-filters" class="tab-pane">
                    <div class="row-fluid">
                        <?php echo $this->loadTemplate('faqtoggle'); ?>     
                    </div>
                </div>
                <div id="page-filters_" class="tab-pane">
                    <div class="row-fluid">
                        <?php echo $this->loadTemplate('contentslider'); ?>  
                    </div>
                </div>
                <div id="page-lightboxgallery" class="tab-pane">
                    <div class="row-fluid">
                        <?php echo $this->loadTemplate('lightboxgallery'); ?>  
                 </div>
                </div>
            </div>
        </div>
