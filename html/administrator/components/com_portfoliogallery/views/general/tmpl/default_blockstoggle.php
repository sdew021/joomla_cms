...
?> 
	<div class="tabsBack" class = "" >
        ...
        <div class="back"><fieldset class="form-horizontal">
                <legend class="legend"><?php echo JText::_('Main Image'); ?></legend>
                <?php foreach ($this->form->getFieldset('mainImage') as $field): ?>
        ...
        <div class="back"><fieldset class="form-horizontal">
                ...
                <?php foreach ($this->form->getFieldset('blocktitle') as $field): ?>
                    <div class="control-group"><?php
                        echo "<div class='control-label'>".$field->label."</div>";
                        echo "<div class='controls'>".$field->input."</div>";
                        ?>
        ...
        <div class="back"><fieldset class="form-horizontal">
                ...
                <?php foreach ($this->form->getFieldset('blockdescription') as $field): ?>
                    <div class="control-group"><?php
                        echo "<div class='control-label'>".$field->label."</div>";
                        echo "<div class='controls'>".$field->input."</div>";
                        ?>
        ...
        <div class="back">
            <fieldset class="form-horizontal">
                ...
                <?php foreach ($this->form->getFieldset('sortingStyles') as $field): ?>
                    <div class="control-group  options-block-title-wrapper first">
                        <?php echo "<div class='control-label'>".$field->label."</div>";
                        echo "<div class='controls'>".$field->input."</div>";
                        ?>
...
<div class="back">
  <fieldset class="form-horizontal">
     <legend class="legend" ><?php echo JText::_('Category Styles'); ?></legend>
            <?php foreach ($this->form->getFieldset('categoryStyles') as $field): ?>
                <div class="control-group  options-block-title-wrapper first">
                <?php echo "<div class='control-label'>".$field->label."</div>";
                      echo "<div class='controls'>".$field->input."</div>";
                  ?>
...
<?php endforeach; ?>
                  ...
                  <legend class="legend"><?php echo JText::_('Link Button'); ?></legend>
                   <?php foreach ($this->form->getFieldset('linkTitle') as $field): ?>
                   <div class="control-group"><?php
                        echo "<div class='control-label'>".$field->label."</div>";
                        echo "<div class='controls'>".$field->input."</div>";
                        ?>
...
<?php endforeach; ?>
        ...
        <div class="back"> <fieldset class="form-horizontal">
                ...
                <?php foreach ($this->form->getFieldset('ContentPaginationPosition') as $field): ?>
                    <div class="control-group  options-block-title-wrapper first">
                        <?php
                        echo "<div class='control-label'>" . $field->label . "</div>";
                        echo "<div class='controls'>" . $field->input . "</div>";
        ...
        <div class="back"> <fieldset class="form-horizontal">
                ...
                <?php foreach ($this->form->getFieldset('ContentLoadMore') as $field): ?>
                    <div class="control-group  options-block-title-wrapper first">
                        <?php
                        echo "<div class='control-label'>" . $field->label . "</div>";
                        echo "<div class='controls'>" . $field->input . "</div>";
