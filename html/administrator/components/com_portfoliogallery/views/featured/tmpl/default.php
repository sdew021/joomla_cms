...
<form action="<?php echo JRoute::_('index.php?option=com_portfoliogallery'); ?>" id="application-form" method="post" name="adminForm" class="form-validate" style="margin-top:10px">
        <div class="element hugeitmicro-item">
            <div class="left-block">
                <div class="main-image-block">
                    <a href="<?php echo JUri::root() . 'media/com_portfoliogallery/images/lightbox.png'; ?>" rel="content"><img src="<?php echo JUri::root() . 'media/com_portfoliogallery/images/lightbox.png'; ?>"></a>
                </div>
            </div>
        ...
        <div class="element hugeitmicro-item">
            <div class="left-block">
                <div class="main-image-block">
                    <a href="<?php echo JUri::root() . 'media/com_portfoliogallery/images/gallery.png'; ?>" rel="content"><img src="<?php echo JUri::root() . 'media/com_portfoliogallery/images/gallery.png'; ?>"></a>
                </div>
            </div>
            <div class="right-block">
                <div class="title-block"><h3>Gallery</h3></div>
                <div class="description-block">
                    <p>Huge - IT Image gallery for Joomla is wonderful extension for those who needs to show image in wonderful gallery with  five views. with the help of our module you can create various sliders with many styles, it includes awesome lightbox with itвЂ™s options for any taste. The module allows to add descriptions and titles for every image of the Gallery.</p>
                </div>			  				
                <div class="button-block">
        ...
        <div class="element hugeitmicro-item">
            <div class="left-block">
                <div class="main-image-block">
                    <a href="<?php echo JUri::root() . 'media/com_portfoliogallery/images/slider.png'; ?>" rel="content"><img src="<?php echo JUri::root() . 'media/com_portfoliogallery/images/slider.png'; ?>"></a>
                </div>
            </div>
            <div class="right-block">
        ...
        <div class="element hugeitmicro-item">
            <div class="left-block">
                <div class="main-image-block">
                    <a href="<?php echo JUri::root() . 'media/com_portfoliogallery/images/videogallery.png'; ?>" rel="content"><img src="<?php echo JUri::root() . 'media/com_portfoliogallery/images/videogallery.png'; ?>"></a>
                </div>
            </div>
            <div class="right-block">
        ...
        <div class="element hugeitmicro-item">
            <div class="left-block">
                <div class="main-image-block">
                    <a href="<?php echo JUri::root() . 'media/com_portfoliogallery/images/slideshow.png'; ?>" rel="content"><img src="<?php echo JUri::root() . 'media/com_portfoliogallery/images/slideshow.png'; ?>"></a>
                </div>
            </div>
            <div class="right-block">
        ...
        <div class="element hugeitmicro-item">
            <div class="left-block">
                <div class="main-image-block">
                    <a href="<?php echo JUri::root() . 'media/com_portfoliogallery/images/map.png'; ?>" rel="content"><img src="<?php echo JUri::root() . 'media/com_portfoliogallery/images/map.png'; ?>"></a>
                </div>
            </div>
            <div class="right-block">
    ...
    <div class="element hugeitmicro-item">
            <div class="left-block">
                <div class="main-image-block">
                    <a href="<?php echo JUri::root() . 'media/com_portfoliogallery/images/catalog.png'; ?>" rel="content"><img src="<?php echo JUri::root() . 'media/com_portfoliogallery/images/catalog.png'; ?>"></a>
                </div>
            </div>
            <div class="right-block">
