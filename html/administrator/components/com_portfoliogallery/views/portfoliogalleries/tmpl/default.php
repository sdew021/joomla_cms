...
<div id="j-main-container" class="span10 j-toggle-main">
    ...
    <form action="<?php echo JRoute::_('index.php?option=com_portfoliogallery'); ?>" method="post" name="adminForm" id="adminForm" style="margin-top:10px">
    <table class="wp-list-table widefat fixed pages" style="width:100%">
        ...
        <th style="text-align: left;"><span><?php echo JText::_('Shortcodes'); ?></span><span class="sorting-indicator"></span></th>
