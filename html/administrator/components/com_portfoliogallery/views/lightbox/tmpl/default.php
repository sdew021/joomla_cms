...
<script type="text/javascript">
    Joomla.submitbutton = function(task)
    {
        ...
        if(task == 'lightbox.apply1' || task == 'lightbox.save') {
...
<form action="<?php echo JRoute::_('index.php?option=com_portfoliogallery&layout=edit&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="adminForm" class="form-validate">
    <div class="tab-content" style = "background:-webkit-linear-gradient(bottom,#ffffff 0%,#ededed 100%)">
        <div  class="back"    style = "border: none; ">
        <div>
          <fieldset class="form-horizontal">
            ...
            <?php foreach ($this->form->getFieldset('Internationalization') as $field) : ?>
				        <div class="control-group" style = 'width: 581px'>
       ...
       <div><fieldset class="form-horizontal">
