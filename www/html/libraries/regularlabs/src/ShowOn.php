...
class ShowOn
{
	public static function open($condition = '', $formControl = '', $group = '', $animate = '', $class = '')
	{
		if ( ! $condition)
		{
			return self::close();
		...
		$json = json_encode(JFormHelper::parseShowOnConditions($condition, $formControl, $group, $animate));
